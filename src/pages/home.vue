      ...
      <div class="content" id="content-body">
        <div class="section">
          <div class="blank-state blank-state-welcome welcome">
            ...
            <p class="blank-state-text">一个快速生成页面的编辑器</p>
          </div>
          <div class="cont">
            <div class="blank-state cont_blank">
              ...
              <h3 class="blank-state-title">创建团队，管理自己的项目</h3>
              <p class="blank-state-text">
                所有的项目都在每个团队中，便于管理自己的项目
              </p>
              <router-link class="btn btn-new" to="groups/new"
                >创建团队
              </router-link>
            </div>
            <div class="blank-state cont_blank">
              ...
              <h3 class="blank-state-title">创建自己的项目</h3>
              <!-- <p class="blank-state-text">
                你可以免费创建
                <strong>20</strong>
                个项目.(当然是骗你的)
              </p> -->
              <router-link class="btn btn-new" to="/projects/new"
                >新建项目
              </router-link>
            </div>
            <div class="blank-state cont_blank">
              ...
              <h3 class="blank-state-title">查看精选模板</h3>
              <!-- <p class="blank-state-text">
                你可以免费创建
                <strong>20</strong>
                个项目.(当然是骗你的)
              </p> -->
              <router-link class="btn btn-new" to="/dashboard/featured"
                >查看精选
              </router-link>
            </div>
          </div>
        ...
        <div
          class="section section-vertical-top"
        ...
        >
          <el-card class="box-card" ref="box-card" desc="今日数据">
            ...
            >
              ...
              <el-table-column prop="null" width="80" label="">
              </el-table-column>
              <el-table-column prop="pv_count" label="浏览量(PV)" align="right">
              </el-table-column>
              <el-table-column
                prop="visitor_count"
                label="访客数(UV)"
              ...
              <el-table-column prop="ip_count" align="right" label="IP数">
              </el-table-column>
              <el-table-column prop="bounce_ratio" align="right" label="跳出率">
              </el-table-column>
              <el-table-column
                prop="avg_visit_time"
                align="right"
              ...
              <el-table-column prop="" width="40" label=""> </el-table-column>
            </el-table>
            <el-table
              v-if="todayData && todayData.byES"
              :data="todayData"
          ...
          <el-card class="box-card" desc="历史趋势">
            <chart
              v-if="chartHeight && historyTrend.x"
              class="mchart"
              :style="{ height: chartHeight }"
              style="width: 85%"
              :options="historyTrendOptions"
            ></chart>
          ...
          <el-card class="box-card" desc="今日趋势">
            <chart
              v-if="chartHeight && todayTrend.x"
              :style="{ height: chartHeight }"
              class="mchart"
              :options="todayTrendOptions"
            ></chart>
          </el-card>
...
export default {
  ...
  async mounted() {
    ...
    Promise.all([
      this.makeHeight(),
      // this.getTodayDataByES(), // api报错了 主页不要这个
      this.getHistoryTrendByES(),
      this.getTodayEntriesByES(),
      this.getTodayTrendByES(),
      this.getPageCount(),
    ])
  },
  methods: {
    ...
    async getHistoryTrendByES() {
      ...
      result = await Server({
        ...
        .catch(() => {})
      var histogram = (result.histogram || []).reduce(
        (o, i) => {
